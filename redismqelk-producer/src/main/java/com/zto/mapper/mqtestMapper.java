...
public interface mqtestMapper {
    ...
    int updateByExampleSelective(@Param("record") mqtest record, @Param("example") mqtestExample example);

    int updateByExample(@Param("record") mqtest record, @Param("example") mqtestExample example);
